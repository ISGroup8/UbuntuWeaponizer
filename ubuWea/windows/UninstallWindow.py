...
class UninstallWindow(tk.Toplevel):
    def __init__(self, root, categories, formatos):
        ...
        self.title("Ubuntu Weaponizer/Uninstall")
        ...
        Label(self, text="Choose what you want to uninstall...", bg=formatos['fondo1'], font=formatos['specialF'],
        ...
        installButton = tk.Button(self, text="Uninstall", width=10, bg=formatos['si'], fg=formatos['colorFontN2'],
    ...
    def install(self, categories, formatos):
        ...
        window.configure(bg=formatos['fondo1'],
                         ...
                         bd=5)
        Label(window,
              text="--> The applicactions are being uninstalled, please wait...\n\nThese are the apps that are going to be uninstalled:",
