...
class UninstallWindow(tk.Toplevel):
    def __init__(self, root):
        ...
        Label(self, text=" Uninstall the things you want =<=)", bg="LightSkyBlue2", font=('DejaVu Sans Mono', 15)) \
    ...
    def check_clicked(self):
        ...
        window.configure(bg="navajo white",
                         ...
                         relief="flat",  # relieve root
                         bd=5)
        Label(window, text="-- App uninstalled --", font=('DejaVu Sans Mono', 15, "bold"),
